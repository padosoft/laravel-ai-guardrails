...
- [x] **294 tests / 707 assertions** GREEN; pint + phpstan level 8 clean. Tests: DB store overlay/upsert/shrunk-allow-list, endpoint show/update/coerce/non-overridable-ignored/422-invalid/missing-body, config|database+master-off bindings, ApiGate flag-off 404.
